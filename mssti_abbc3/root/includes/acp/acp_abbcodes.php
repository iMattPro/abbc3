	...
	*/
	...
	//	$isfounder = ($user->data['user_type'] == USER_FOUNDER) ? true : false;
		...
		$template->assign_vars(array(
			...
			'L_NO_EXIST_EXPLAIN_LITEBOX'		=> sprintf($user->lang['NO_EXIST_EXPLAIN_OTHERS'], "lightbox.js", "2.5", "{$board_path}lightbox/", "Lightbox2", "http://lokeshdhakar.com/projects/lightbox2/"),
