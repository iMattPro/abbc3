...
// Text to be applied to the helpline & mouseover & help page & Wizard texts
	...
	'SAMPLE_TEXT'				=> 'Dies ist ein Beispieltext',
	'DEPRECATED_BBCODE'			=> '<strong class="error">Hinweis:</strong> Diese BBCode ist veraltet und wurde durch BBvideo ersetzt worden.',
));
...
// bbcodes texts
	...
	'ABBC3_CODE_VIEW'			=> '[code]' . $lang['SAMPLE_TEXT'] . '[/code] oder [code=php]' . $lang['SAMPLE_TEXT'] . '[/code]',
...
##	For translator:                                           yes                         Yes               Yes
	'ABBC3_ANCHOR_VIEW'			=> '[anchor=help_0 goto=help_1]Gehe zum Link 1[/anchor]<br /> oder  [anchor=help_1]Das ist der Link 1[/anchor]',
