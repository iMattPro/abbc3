...
$lang = array_merge($lang, array(
	'ABBC3_SETTINGS_EXPLAIN'	=> 'Ici, vous pouvez configurer les paramètres de ' . \vse\abbc3\ext::ABBC3_EXT_NAME . '. Pour plus d’informations sur la personnalisation de la barre d’icônes, visitez le site %s.',
	'ABBC3_GOOGLE_FONTS_INFO'	=> 'Ajoutez <strong><a href="https://fonts.google.com" target="_blank" rel="noopener noreferrer">Google Fonts</a></strong> à la <samp class="error">[font]</samp> BBCode. Utilisez une orthographe exacte et respectez la casse. Placez chaque nom de police sur une ligne distincte.',
	...
	'ABBC3_BBCODE_BAR_EXPLAIN'	=> 'Cela affichera la barre d’outils de l’icône BBCode. Désactivez cette option pour afficher les boutons BBCode par défaut de phpBB.',
	'ABBC3_QR_BBCODES'			=> 'Activer les BBCodes dans la réponse rapide',
	'ABBC3_QR_BBCODES_EXPLAIN'	=> 'Cela ajoutera des boutons BBCode à la réponse rapide.',
	'ABBC3_ICONS_TYPE'			=> 'Format de d’image de la barre d’icônes',
	'ABBC3_ICONS_TYPE_EXPLAIN'	=> 'Choisissez le format d’image à utiliser pour les icônes d’Advanced BBCodes. Notez que vous ne pouvez choisir qu’un seul format pour toutes vos icônes.',
