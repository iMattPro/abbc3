...
$lang = array_merge($lang, array(
	'ABBC3_SETTINGS_EXPLAIN'	=> '在此您可以修改 ' . \vse\abbc3\ext::ABBC3_EXT_NAME . ' 的设置。 要了解有关定制图标栏的信息，请访问 %s。',
	...
	'ABBC3_BBCODE_BAR_EXPLAIN'	=> '启用此选项可显示基于图标的 BBCode 工具栏。禁用它则会用 phpBB 自带的默认 BBCode 按钮。 ',
	'ABBC3_QR_BBCODES'			=> '在快速回复中启用 BBCode',
	'ABBC3_QR_BBCODES_EXPLAIN'	=> '这回在快速回复编辑器中启用 BBCode 的按钮。',
	'ABBC3_ICONS_TYPE'			=> '图标栏的图片格式',
	'ABBC3_ICONS_TYPE_EXPLAIN'	=> '选择用于 BBCode 图标的图片格式。注意您只能选择一种并用于所有的图标。 ',
