...
$lang = array_merge($lang, array(
	'ABBC3_SETTINGS_EXPLAIN'	=> 'Здесь можно изменить настройки расширения «' . \vse\abbc3\ext::ABBC3_EXT_NAME . '». Для получения дополнительной информации о настройке панели с иконками, откройте %s.',
	...
	'ABBC3_BBCODE_BAR_EXPLAIN'	=> 'Данная опция позволяет включить панель с иконками ББ-кодов. Отключите эту панель для использования панели, установленной в phpBB по умолчанию.',
	...
	'ABBC3_ICONS_TYPE_EXPLAIN'	=> 'Выберите формат значка для значков ББ-кодов. Вы можете выбрать только один формат сразу для всех иконок на панели.',
