...
$lang = array_merge($lang, array(
	...
	'ABBC3_AUTOVIDEO_HELPLINE'	=> 'Incrustar archivos de vídeo MP4/OGG/WEBM: la URL debe comenzar con <samp class="error">https</samp> o <samp class="error">http</samp> y terminar con <samp class="error">.mp4</samp>, <samp class="error">.ogg</samp> o <samp class="error">.webm</samp> (no se necesita BBCode). Tenga en cuenta que la compatibilidad con el navegador y la implementación de la GUI varían.',
	...
	'ABBC3_BBCODE_ORDER_NO_DATA'	=> 'No se han recibido datos de orden de BBCode.',
