...
$lang = array_merge($lang, array(
	...
	'ABBC3_CENTER_HELPLINE'		=> 'Centrar el texto: [center]text[/center]',
	...
	'ABBC3_JUSTIFY_HELPLINE'	=> 'Justifica el texto: [justify]text[/justify]',
	'ABBC3_LEFT_HELPLINE'		=> 'Alinear texto a la izquierda: [left]text[/left]',
	...
	'ABBC3_RIGHT_HELPLINE'		=> 'Alinear texto a la derecha: [right]text[/right]',
	...
	'ABBC3_TABLE_HELPLINE'		=> 'Crea una tabla: [table]text[/table]',
	'ABBC3_TD_HELPLINE'			=> 'Añade una celda a la tabla: [td]text[/td]',
	'ABBC3_TR_HELPLINE'			=> 'Añade una columna a la tabla: [tr]text[/tr]',
	'ABBC3_USERS_HELPLINE'		=> 'Ocultar texto para invitados: [users]text[/users]',
	'ABBC3_YOUTUBE_HELPLINE'	=> 'Vídeo de YouTube: [youtube]http://youtube_url[/youtube]',

	// Utility BBCodes
	'ABBC3_COPY_BBCODE'			=> 'Copiar el texto seleccionado',
	'ABBC3_CUT_BBCODE'			=> 'Corta el texto seleccionado',
	...
	'ABBC3_UNDO_BBCODE'			=> 'Acción de Deshacer',
	'ABBC3_REDO_BBCODE'			=> 'Acción de Rehacer',
