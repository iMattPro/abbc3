...
$lang = array_merge($lang, array(
	...
	'ABBC3_CENTER_HELPLINE'		=> 'Align text to center: [center]text[/center]',
	...
	'ABBC3_JUSTIFY_HELPLINE'	=> 'Align text to justify: [justify]text[/justify]',
	'ABBC3_LEFT_HELPLINE'		=> 'Align text to left: [left]text[/left]',
	...
	'ABBC3_RIGHT_HELPLINE'		=> 'Align text to right: [right]text[/right]',
	...
	'ABBC3_TABLE_HELPLINE'		=> 'Make a table: [table]text[/table]',
	'ABBC3_TD_HELPLINE'			=> 'Add a cell to the row table: [td]text[/td]',
	'ABBC3_TR_HELPLINE'			=> 'Add a row to the table: [tr]text[/tr]',
	'ABBC3_USERS_HELPLINE'		=> 'Hide from guests: [users]text[/users]',
	'ABBC3_YOUTUBE_HELPLINE'	=> 'YouTube Video: [youtube]http://youtube_url[/youtube]',

	// Utility BBCodes
	'ABBC3_COPY_BBCODE'			=> 'Copy selected text',
	'ABBC3_CUT_BBCODE'			=> 'Cut selected text',
	...
	'ABBC3_UNDO_BBCODE'			=> 'Undo action',
	'ABBC3_REDO_BBCODE'			=> 'Redo action',
