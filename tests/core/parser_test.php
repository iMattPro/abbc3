...
class parser_test extends \phpbb_test_case
{
	...
	public function pre_parse_data()
	{
		...
		return array(
			...
			array( // convert (no UID)
				array(
					'text' => '[BBvideo 560,340]http://youtu.be/XXXXXXXXXXX[/BBvideo]',
					'uid' => '2sy55ot3'
				),
				'[bbvideo=560,340]http://youtu.be/XXXXXXXXXXX[/bbvideo]',
			),
			...
			array( // convert (no size or UID)
				array(
					'text' => '[BBvideo]http://youtu.be/XXXXXXXXXXX[/BBvideo]',
					'uid' => '2sy55ot3'
				),
				'[bbvideo=' . $this->bbvideo_width . ',' . $this->bbvideo_height . ']http://youtu.be/XXXXXXXXXXX[/bbvideo]',
			),
			...
			array( // convert multiple bbvideos
				array(
					'text' => 'Hello [BBvideo]http://youtu.be/XXXXXXXXXXX[/BBvideo] [bbvideo:2sy55ot3]http://youtu.be/ZZZZZZZZZZ[/bbvideo:2sy55ot3] Goodbye world',
					'uid' => '2sy55ot3'
				),
				'Hello [bbvideo=' . $this->bbvideo_width . ',' . $this->bbvideo_height . ']http://youtu.be/XXXXXXXXXXX[/bbvideo] [bbvideo=' . $this->bbvideo_width . ',' . $this->bbvideo_height . ':2sy55ot3]http://youtu.be/ZZZZZZZZZZ[/bbvideo:2sy55ot3] Goodbye world',
			),
