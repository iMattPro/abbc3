...
//	                             'bbcode_tag', 'bbcode_order', 'bbcode_id', 'bbcode_helpline', 'bbcode_match', 'bbcode_tpl', 'first_pass_match', 'first_pass_replace', 'second_pass_match', 'second_pass_replace', 'display_on_posting', 'display_on_pm', 'display_on_sig', 'abbcode', 'bbcode_image', 'bbcode_group'; 
		...
		'video'			=> array("video",			70, 1,	"ABBC3_VIDEO_TIP",		 "[video{TEXT}]{URL}[/video]", "<a src=\"{URL}\">{TEXT}</a>", "!\[video(\\=| )?(.*?)\](.*?)\[/video\]!ies", '\'[video${1}${2}:$uid]\'.trim(\'${3}\').\'[/video:$uid]\'', '!\[video((=| )?(width=)?([0-9]?[0-9]?[0-9])(,| )(height=)?([0-9]?[0-9]?[0-9]))?:$uid\](.*?)\[/video:$uid\]!s', '<object id="player_${8}" width="${4}" height="${7}" type="video/x-ms-wmv"><param name="filename" value="${8}"><param name="Showcontrols" value="true"><param name="autoStart" value="false"><param name="autostart" value="false" /><param name="showcontrols" value="true" /><param name="showdisplay" value="false" /><param name="showstatusbar" value="false" /><param name="autosize" value="true" /><param name="visible" value="true" /><param name="animationstart" value="false" /><param name="loop" value="false" /><embed type="application/x-mplayer2" src="${8}" width="${4}" height="${7}" controller="true" showcontrols="true" showdisplay="false" showstatusbar="true" autosize="true" autostart="false" visible="true" animationstart="false" loop="false"></embed></object><br />', 0, 0, 0, 1, "video.gif"),
		'stream'		=> array("stream",			71, 1,	"ABBC3_STREAM_TIP",		 "[stream]{URL}[/stream]", "<a src=\"{URL}\">{URL}</a>", "!\[stream\](.*?)\[/stream\]!ies", '\'[stream:$uid]\'.trim(\'${1}\').\'[/stream:$uid]\'', '!\[stream:$uid\](.*?)\[/stream:$uid\]!s', '<object id="wmstream_${1}" width="320" height="45" type="video/x-ms-wmv"><param name="filename" value="${1}"><param name="Showcontrols" value="true"><param name="autoStart" value="false"><param name="autostart" value="false" /><param name="showcontrols" value="true" /><param name="showdisplay" value="false" /><param name="showstatusbar" value="false" /><param name="autosize" value="true" /><param name="visible" value="true" /><param name="animationstart" value="false" /><param name="loop" value="false" /><embed type="application/x-mplayer2" src="${1}" width="320" height="45" controller="true" showcontrols="true" showdisplay="false" showstatusbar="true" autosize="true" autostart="false" visible="true" animationstart="false" loop="false"></embed></object><br />', 0, 0, 0, 1, "sound.gif"),
		...
		'ram'			=> array("ram",				73, 1,	"ABBC3_RAM_TIP",		 "[ram{TEXT}]{URL}[/ram]", "<a src=\"{URL}\">{TEXT}</a>", "!\[ram(\\=| )?(.*?)\](.*?)\[/ram\]!ies", '\'[ram${1}${2}:$uid]\'.trim(\'${3}\').\'[/ram:$uid]\'', '!\[ram((=| )?(width=)?([0-9]?[0-9]?[0-9])(,| )(height=)?([0-9]?[0-9]?[0-9]))?:$uid\](.*?)\[/ram:$uid\]!s', '<object id="rmstream_${8}" width="$(4)" height="${7}" type="audio/x-pn-realaudio-plugin" data="${8}"><param name="src" value="${8}" /><param name="autostart_step" value="false" /><param name="autostart" value="false" /><param name="controls" value="ImageWindow" /><param name="console" value="ctrls_${8}" /><param name="prefetch" value="false" /></object><br /><object id="ctrls_${8}" type="audio/x-pn-realaudio-plugin" width="${4}" height="36"><param name="controls" value="ControlPanel" /><param name="console" value="ctrls_${8}" /></object><br />', 0, 0, 0, 1, "ram.gif"),
