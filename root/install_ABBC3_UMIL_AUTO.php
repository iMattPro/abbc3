...
* @version: $Id: install_abbc3.php, v 3.0.8 2010/07/11 10:07:11 leviatan21 Exp $
...
//	                             'bbcode_tag', 'bbcode_order', 'bbcode_id', 'bbcode_helpline', 'bbcode_match', 'bbcode_tpl', 'first_pass_match', 'first_pass_replace', 'second_pass_match', 'second_pass_replace', 'display_on_posting', 'display_on_pm', 'display_on_sig', 'abbcode', 'bbcode_image', 'bbcode_group'; 
		...
		'flv'			=> array("flv",				69, 1,	"ABBC3_FLV_TIP",		 "[flv{TEXT}]{URL}[/flv]", "<a src=\"{URL}\">{TEXT}</a>", "!\[flv(\\=| )?(.*?)\](.*?)\[/flv\]!ies", '\'[flv${1}${2}:$uid]\'.trim(\'${3}\').\}[/flv:$uid]\'', '!\[flv((=| )?(width=)?([0-9]?[0-9]?[0-9])(,| )(height=)?([0-9]?[0-9]?[0-9]))?:$uid\](.*?)\[/flv:$uid\]!se', '$this->auto_embed_video(\'./images/player.swf\', \'${4}\', \'${7}\', \'movie=${8}&fgcolor=autoload=off&fgcolor=0xff0000&autoload=off&volume=70\')', 0, 0, 0, 1, "flashflv.gif"),
		'video'			=> array("video",			70, 1,	"ABBC3_VIDEO_TIP",		 "[video{TEXT}]{URL}[/video]", "<a src=\"{URL}\">{TEXT}</a>", "!\[video(\\=| )?(.*?)\](.*?)\[/video\]!ies", '\'[video${1}${2}:$uid]\'.trim(\'${3}\').\[/video:$uid]\'', '!\[video((=| )?(width=)?([0-9]?[0-9]?[0-9])(,| )(height=)?([0-9]?[0-9]?[0-9]))?:$uid\](.*?)\[/video:$uid\]!s', '<object classid="CLSID:6BF52A52-394A-11d3-B153-00C04F79FAA6" id="player_${8}" width="${4}" height="${7}"><param name="url" value="${8}" /><param name="src" value="${8}" /><param name="showcontrols" value="1" /><param name="autostart_step" value="0" /><param name="autostart" value="0" /><!--[if !IE]>--><object type="video/x-ms-wmv" data="${8}" width="${4}" height="${7}" ><param name="src" value="${8}" /><param name="autostart_step" value="0" /><param name="autostart" value="0" /><param name="controller" value="1" /></object><!--<![endif]--></object><br />', 0, 0, 0, 1, "video.gif"),
		'stream'		=> array("stream",			71, 1,	"ABBC3_STREAM_TIP",		 "[stream]{URL}[/stream]", "<a src=\"{URL}\">{URL}</a>", "!\[stream\](.*?)\[/stream\]!ies", '\'[stream:$uid]\'.trim(\'${1}\').\[/stream:$uid]\'', '!\[stream:$uid\](.*?)\[/stream:$uid\]!s', '<object width="320" height="45" classid="CLSID:6BF52A52-394A-11d3-B153-00C04F79FAA6" id="wmstream_${1}"><param name="url" value="${1}" /><param name="showcontrols" value="1" /><param name="showdisplay" value="0" /><param name="showstatusbar" value="0" /><param name="autosize" value="1" /><param name="autostart_step" value="0" /><param name="autostart" value="0" /><param name="visible" value="1" /><param name="animationstart_step" value="0" /><param name="loop" value="0" /><param name="src" value="${1}" /><!--[if !IE]>--><object width="320" height="45" type="video/x-ms-wmv" data="${1}"><param name="src" value="${1}" /><param name="controller" value="1" /><param name="showcontrols" value="1" /><param name="showdisplay" value="0" /><param name="showstatusbar" value="0" /><param name="autosize" value="1" /><param name="autostart_step" value="0" /><param name="autostart" value="0" /><param name="visible" value="1" /><param name="animationstart_step" value="0" /><param name="loop" value="0" /></object><!--<![endif]--></object><br />', 0, 0, 0, 1, "sound.gif"),
		'quicktime'		=> array("quicktime",		72, 1,	"ABBC3_QUICKTIME_TIP",	 "[quicktime{TEXT}]{URL}[/quicktime]", "<a src=\"{URL}\">{TEXT}</a>", "!\[quicktime(\\=| )?(.*?)\](.*?)\[/quicktime\]!ies", '\'[quicktime${1}${2}:$uid]\'.trim(\'${3}\').\[/quicktime:$uid]\'', '!\[quicktime((=| )?(width=)?([0-9]?[0-9]?[0-9])(,| )(height=)?([0-9]?[0-9]?[0-9]))?:$uid\](.*?)\[/quicktime:$uid\]!s', '<object classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" codebase="http://www.apple.com/qtactivex/qtplugin.cab" width="${4}" height="${7}"><param name="src" value="${8}" /><param name="controller" value="1" /><param name="autoplay" value="0" /><!--[if !IE]>--><object type="video/quicktime" data="${8}" width="${4}" height="${7}"><param name="autoplay" value="0" /><param name="controller" value="1" /></object><!--<![endif]--></object><br />', 0, 0, 0, 1, "quicktime.gif"),
		'ram'			=> array("ram",				73, 1,	"ABBC3_RAM_TIP",		 "[ram{TEXT}]{URL}[/ram]", "<a src=\"{URL}\">{TEXT}</a>", "!\[ram(\\=| )?(.*?)\](.*?)\[/ram\]!ies", '\'[ram${1}${2}:$uid]\'.trim(\'${3}\').\[/ram:$uid]\'', '!\[ram((=| )?(width=)?([0-9]?[0-9]?[0-9])(,| )(height=)?([0-9]?[0-9]?[0-9]))?:$uid\](.*?)\[/ram:$uid\]!s', '<object id="rmstream_${8}" classid="clsid:CFCDAA03-8BE4-11cf-B84B-0020AFBBCCFA" width="$(4)" height="${7}"><param name="src" value="${8}" /><param name="autostart_step" value="false" /><param name="autostart" value="false" /><param name="controls" value="ImageWindow" /><param name="console" value="ctrls_${8}" /><param name="prefetch" value="false" /><embed name="rmstream_${8}" type="audio/x-pn-realaudio-plugin" src="${8}" width="${4}" height="${7}" autostart_step="false" autostart="false" controls="ImageWindow" console="ctrls_${8}" prefetch="false"></embed></object><br /><object id="ctrls_${8}" classid="clsid:CFCDAA03-8BE4-11cf-B84B-0020AFBBCCFA" width="${4}" height="36"><param name="controls" value="ControlPanel" /><param name="console" value="ctrls_${8}" /><embed name="ctrls_${8}" type="audio/x-pn-realaudio-plugin" width="${4}" height="36" controls="ControlPanel" console="ctrls_${8}"></embed></object><br />', 0, 0, 0, 1, "ram.gif"),
		'gvideo'		=> array("gvideo",			74, 1,	"ABBC3_GVIDEO_TIP",		 "[GVideo]{URL}[/GVideo]", "<a src=\"{URL}\">{URL}</a>", "!\[Gvideo\]http://video.google.(.*?)/videoplay\?docid\=(.*?)\[/Gvideo\]!ies", '\'[Gvideo:$uid]http://video.google.${1}/videoplay?docid=${2}[/Gvideo:$uid]\'', '!\[Gvideo:$uid\]http://video.google.(.*?)/videoplay\?docid\=(.*?)\[/Gvideo:$uid\]!se', '$this->auto_embed_video(\'http://video.google.$1/googleplayer.swf?docid=$2\', \'425\', \'350\')', 0, 0, 0, 1, "googlevid.gif"),
		'youtube'		=> array("youtube",			75, 1,	"ABBC3_YOUTUBE_TIP",	 "[youtube]{URL}[/youtube]", "<a src=\"{URL}\">{URL}</a>", "!\[youtube\]http://((.*?)?)youtube.com/watch\?v\=([0-9A-Za-z-_]{11})[^[]*\[/youtube\]!ies", '\'[youtube:$uid]http://${1}youtube.com/watch?v=${3}[/youtube:$uid]\'', '!\[youtube:$uid\]http://((.*?)?)youtube.com/watch\?v\=([0-9A-Za-z-_]{11})[^[]*\[/youtube:$uid\]!se', '$this->auto_embed_video(\'http://${2}youtube.com/v/${3}\', \'425\', \'350\')', 0, 0, 0, 1, "youtube.gif"),
		'veoh'			=> array("veoh", 			76, 1,	"ABBC3_VEOH_TIP",		 "[veoh]{URL}[/veoh]", "<a src=\"{URL}\">{URL}</a>", "!\[veoh\]http://(.*?).veoh.com/videos/(.*?)\[/veoh\]!ies", '\'[veoh:$uid]http://${1}.veoh.com/videos/${2}[/veoh:$uid]\'', '!\[veoh:$uid\]http://(.*?).veoh.com/videos/(.*?)\[/veoh:$uid\]!se', '$this->auto_embed_video(\'http://${1}.veoh.com/videodetails2.swf?permalinkId=${2}&id=anonymous&player=videodetailsembedded&videoAutoPlay=0\', \'540\', \'438\')', 0, 0, 0, 1, "veoh.gif"),
		'collegehumor'	=> array("collegehumor", 	77, 1,	"ABBC3_COLLEGE_TIP",	 "[collegehumor]{URL}[/collegehumor]", "<a src=\"{URL}\">{URL}</a>", "!\[collegehumor\]http://www.collegehumor.com/video:(.*?)\[/collegehumor\]!ies", '\'[collegehumor:$uid]http://www.collegehumor.com/video:${1}[/collegehumor:$uid]\'', '!\[collegehumor:$uid\]http://www.collegehumor.com/video:(.*?)\[/collegehumor:$uid\]!se', '$this->auto_embed_video(\'http://www.collegehumor.com/moogaloop/moogaloop.swf?clip_id=${1}&fullscreen=1\', \'480\', \'360\')', 0, 0, 0, 1, "collegehumor.gif"),
		'dm'			=> array("dm", 				78, 1,	"ABBC3_DMOTION_TIP",	 "[dm]{URL}[/dm]", "<a src=\"{URL}\">{URL}</a>", "!\[dm\](.*?)\[/dm\]!ies", '\'[dm:$uid]\'.trim(\'${1}\').\[/dm:$uid]\'', '!\[dm:$uid\]http://www.dailymotion.com/(.*?)/(.*?)\[/dm:$uid\]!se', '$this->auto_embed_video(\'http://www.dailymotion.com/swf/${2}\', \'420\', \'352\')', 0, 0, 0, 1, "dailymotion.gif"),
		'gamespot'		=> array("gamespot",		79, 1,	"ABBC3_GAMESPOT_TIP",	 "[gamespot]{URL}[/gamespot]", "<a src=\"{URL}\">{URL}</a>", "!\[gamespot\]http://www.gamespot.com/video/(.*?)/(.*?)\[/gamespot\]!ies", '\'[gamespot:$uid]http://www.gamespot.com/video/${1}/${2}[/gamespot:$uid]\'', '!\[gamespot:$uid\]http://www.gamespot.com/video/(.*?)/(.*?)\[/gamespot:$uid\]!se', '$this->auto_embed_video(\'http://image.com.com/gamespot/images/cne_flash/production/media_player/proteus/gs/proteus_embed.swf\', \'432\', \'355\', \'paramsURI=http%3A%2F%2Fwww%2Egamespot%2Ecom%2Fpages%2Fvideo%5Fplayer%2Fproteus%5Fxml%2Ephp%3Fadseg%3D%26adgrp%3D%26sid%3D${2}%26pid%3D${1}%26mb%3D%26onid%3D%26nc%3D1202626246593%26embedded%3D1%26showWatermark%3D0%26autoPlay%3D0\')', 0, 0, 0, 1, "gamespot.gif"),
		'gametrailers'	=> array("gametrailers",	80, 1,	"ABBC3_GAMETRAILERS_TIP","[gametrailers]{URL}[/gametrailers]", "<a src=\"{URL}\">{URL}</a>", "!\[gametrailers\]http://www.gametrailers.com/player/(.*?).html\[/gametrailers\]!ies", '\'[gametrailers:$uid]http://www.gametrailers.com/player/${1}.html[/gametrailers:$uid]\'', '!\[gametrailers:$uid\]http://www.gametrailers.com/player/(.*?).html\[/gametrailers:$uid\]!se', '$this->auto_embed_video(\'http://www.gametrailers.com/remote_wrap.php?mid=${1}\', \'480\', \'392\')', 0, 0, 0, 1, "gametrailers.gif"),
		'ignvideo'		=> array("ignvideo",		81, 1,	"ABBC3_IGNVIDEO_TIP",	 "[ignvideo]{URL}[/ignvideo]", "<a src=\"{URL}\">{URL}</a>", "!\[ignvideo\](.*?)\[/ignvideo\]!ies", '\'[ignvideo:$uid]${1}[/ignvideo:$uid]\'', '!\[ignvideo:$uid\](.*?)\[/ignvideo:$uid\]!se', '$this->auto_embed_video(\'http://videomedia.ign.com/ev/ev.swf\', \'433\', \'360\', \'${1}\')', 0, 0, 0, 1, "ign.gif"),
		'liveleak'		=> array("liveleak",		82, 1,	"ABBC3_LIVELEAK_TIP",	 "[liveleak]{URL}[/liveleak]", "<a src=\"{URL}\">{URL}</a>", "!\[liveleak\]http://www.liveleak.com/view\?i\=(.*?)\[/liveleak\]!ies", '\'[liveleak:$uid]http://www.liveleak.com/view?i=${1}[/liveleak:$uid]\'', '!\[liveleak:$uid\]http://www.liveleak.com/view\?i\=(.*?)\[/liveleak:$uid\]!se', '$this->auto_embed_video(\'http://www.liveleak.com/e/${1}\', \'450\', \'370\')', 0, 0, 0, 1, "liveleak.gif"),
